...
const REGISTRY: Record<string, Loader> = {
  BranchCommand:        async () => (await import('../../slash/branch')).BranchCommand,
  ...
  ConfigCommand:        async () => (await import('../../slash/config')).ConfigCommand,
  CostCommand:          async () => (await import('../../slash/cost')).CostCommand,
  DeleteSessionCommand: async () => (await import('../../slash/delete-session')).DeleteSessionCommand,
  ExitCommand:          async () => (await import('../../slash/exit')).ExitCommand,
  HelpCommand:          async () => (await import('../../slash/help')).HelpCommand,
  HistoryCommand:       async () => (await import('../../slash/history')).HistoryCommand,
