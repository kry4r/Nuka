...
//
// Tier-1 #2 — code-reuse / quality / efficiency review trio.
// Ported from Nuka-Code's `src/skills/bundled/simplify.ts`. Body is a
// static markdown prompt; the original `AGENT_TOOL_NAME` constant is
// replaced with the literal `'AgentTool'` (Nuka's agent dispatch
// surface). Always-on (no env gate); keyword-activated.
